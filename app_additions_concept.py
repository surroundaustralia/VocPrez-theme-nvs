...
def concept(vocab_id, concept_id, version_no=None):
    ...
    # )
    vocab_uri = config.ABSOLUTE_URI_BASE + "/collection/{}/current/".format(vocab_id, concept_id)
    if version_no is not None:
        concept_uri = config.ABSOLUTE_URI_BASE + "/collection/{}/current/{}/{}/".format(vocab_id, concept_id, version_no)
    else:
        concept_uri = config.ABSOLUTE_URI_BASE + "/collection/{}/current/{}/".format(vocab_id, concept_id)
...
def standard_name_concept(concept_id):
    ...
    vocab_uri = config.ABSOLUTE_URI_BASE + "/standard_name/"
    concept_uri = config.ABSOLUTE_URI_BASE + "/standard_name/{}/".format(concept_id)
